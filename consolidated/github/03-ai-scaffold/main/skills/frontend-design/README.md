...
## Skill Overview
This skill provides a complete methodology for frontend development, including design tokens, accessibility guidelines, and best practices for building responsive, maintainable, and accessible web applications.
...
- **tokens.css**: Design token system with semantic colors, typography, spacing, radius, shadows, and motion tokens
...
Use this skill when building websites, web applications, or web components, and when user mentions design styles, creating dashboards, landing pages, or any web UI.

### Basic Usage
1. **Read SKILL.md** for complete methodology
2. **Choose a design direction** (e.g., Minimal SaaS, Bold Editorial)
