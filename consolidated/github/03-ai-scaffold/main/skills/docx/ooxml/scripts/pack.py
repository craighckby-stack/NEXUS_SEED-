...
def pack_document(input_dir, output_file, validate=False):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        xml_files = list(temp_content_dir.rglob("*.xml")) + list(temp_content_dir.rglob("*.rels"))
...
def validate_document(doc_path):
    ...
    Args:
        doc_path: Path to document to be validated
...
def condense_xml(xml_file):
    """
    Strip unnecessary whitespace and remove comments from xml_file.
