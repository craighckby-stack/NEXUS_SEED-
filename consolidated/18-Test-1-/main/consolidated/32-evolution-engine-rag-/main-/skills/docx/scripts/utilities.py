...
class XMLEditor:
    ...
    def __init__(self, xml_path: Union[str, Path]):
        ...
        parser = self._create_line_tracking_parser()
    ...
    def _get_element_text(self, elem: defusedxml.minidom.Element) -> str:
        """
    ...
    def replace_node(
        self, elem: defusedxml.minidom.Element, new_content: str
    ) -> list[defusedxml.minidom.Node]:
        """
    ...
    def insert_after(
        self, elem: defusedxml.minidom.Element, xml_content: str
    ) -> list[defusedxml.minidom.Node]:
        """
    ...
    def _parse_fragment(self, xml_content: str) -> list[defusedxml.minidom.Node]:
        """
    ...
    @staticmethod
    def _create_line_tracking_parser() -> defusedxml.sax.xmlreader.XMLReader:
        """
