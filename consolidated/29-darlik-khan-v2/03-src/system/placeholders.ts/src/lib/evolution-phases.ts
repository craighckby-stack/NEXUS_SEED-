...
export type EvolutionPhase = 
  | 'question'      // Phase 1: Generate technical question
  | 'answer'        // Phase 2: Get AI answer
  | 'debate'        // Phase 3: PRO/CON analysis
  | 'decision'       // Phase 4: Decide to proceed
  | 'mutation'       // Phase 5: Mutate code
  | 'commit'         // Phase 6: Commit to GitHub
  | 'deployment';    // Phase 7: Monitor deployment
...
/**
 * Get next phase in evolution cycle
 */
