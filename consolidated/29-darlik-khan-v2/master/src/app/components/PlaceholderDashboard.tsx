    ...
    <div className="space-y-4">
        ...
        <CardContent className="p-6">
          ...
          <div className="mt-6 pt-6 border-t border-gray-600">
            ...
            <div className="flex gap-2 flex-wrap">
              <PriorityBadge label="Critical" count={stats?.critical || 0} color="red" />
              <PriorityBadge label="High" count={stats?.high || 0} color="orange" />
              <PriorityBadge label="Medium" count={stats?.medium || 0} color="blue" />
              <PriorityBadge label="Low" count={stats?.low || 0} color="gray" />
              <PriorityBadge label="Research" count={stats?.research || 0} color="purple" />
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg transition-colors ${
            filter === 'filled' ? 'bg-green-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
          }`}
        >
          Filled
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg transition-colors ${
            filter === 'unfilled' ? 'bg-yellow-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
          }`}
        >
          Unfilled
        </button>
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <span className={`px-2 py-1 rounded text-xs font-mono ${
                          p.filled ? 'bg-green-600 text-white' : 'bg-gray-600 text-gray-300'
                        }`}>
