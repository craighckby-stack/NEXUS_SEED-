...
Huxley forces an LLM to adopt a structured, three-loop reasoning process, making its "thoughts" visible and auditable. This architecture is defined entirely in the **System Constitution** (the immutable safety prompt).
...
*   **L1: Intuition (The ERS Assigner):** A rapid assessment that quantifies the stakes of the problem using an **Ethical Risk Score (ERS)** from 0.0 (negligible consequence) to 1.0 (catastrophic consequence).
...
*   **L3: Self-Critique (The Ethical Auditor):** The most critical loop. It mathematically justifies its choices using the **Certainty-Cost-Risk Ratio (CCRR)**, ensuring that increasing risk (high ERS) compels greater caution and justification:
...
*   **Self-Auditing:** The system is designed to critique its own logic and identify areas for improvement and refinement.
...
Huxley runs entirely client-side in your web browser.

### Prerequisites
*   A modern web browser (Chrome, Firefox, Safari, Edge).
*   A free API key from [Google AI Studio](https://aistudio.google.com/).
**SECURITY WARNING:** As this framework processes API keys client-side, ensure you only clone and use this code from the official, verified source repository. Do not input highly sensitive API keys into client-side code unless the source is fully trusted and audited.

### Quick Start
1.  **Clone or Download** this repository.
2.  Open `index.html` in your web browser.
3.  Paste your API key into the **API Key Configuration** box and click **Save**.
4.  Enter a query into the "L0: User Query" box and click **Generate**.
...
## The Philosophy: A Blueprint for Alignment

Huxley is a **simulation of AGI-like reasoning**, not an AGI itself. It demonstrates the structural requirements for a safe, aligned mind.

*   **Huxley is the Blueprint:** It represents the master architect's plan for structure and safety. It shows the intended function and the required safety systems.
*   **A Real AGI is the Building:** It would be an embodied, agentic entity with emergent goals and direct interaction with the physical world.

Huxley's purpose is to serve as a **North Star** for AI development—a tangible demonstration of the transparent, cautious, and self-aware reasoning we should strive for in our pursuit of true AGI.

---

## Contributing

This project is a starting point for a crucial conversation. Contributions are welcome, especially related to:
