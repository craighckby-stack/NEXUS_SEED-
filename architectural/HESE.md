...
* Max files per session: 50 (limited by standard velocity limits)
* Max mutations per file: 3 (limited by standard velocity limits)
* Cool-down between sessions: 30 minutes (standard cool-down period)
* Max consecutive mutations without validation: 10 (standard maximum for unreviewed mutations)
