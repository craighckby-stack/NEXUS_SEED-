...
*   **CHAIN CONTEXT:** CHAINED CONTEXT NO LONGER "NONE." INSTEAD, IT IS NOW THE PREVIOUS ROUND'S CHAINED CONTEXT, WHICH IS INCLUDED IN CURRENT ROUND'S CHAINED CONTEXT FOR CROSS-FILE SATURATION CHECKS.
*   **SATURATION LEVEL:** STILL SET TO "YELLOW_STANDARD" (DEFAULT).
*   **SESSION PARAMETERS:** SAME AS PREVIOUS ROUND. NO CHANGES.

**CURRENT EQUATION:** `SATURATION_LEVEL * CHAINED_CONTEXT * SESSION_PARAMETERS`

**EQUATION IMPACT ON SYSTEM BEHAVIOR:**

*   **CHAIN CONTEXT:** 1 (PREVIOUS ROUND'S CHAINED CONTEXT)
...
**FINALIZED EQUATION:** `(YELLOW_STANDARD * CHAINED_CONTEXT) * SESSION_PARAMETERS = SATURATION GUIDELINES APPLIED FOR ROUND 2`
